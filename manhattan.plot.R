...
manhattan.plot<-function(chr, pos, pvalue, 
                         ...
                         xlab="Linkage group", ylab=expression(-log[10](italic(p))),
                         col=c("gray","darkgray"), panel.extra=NULL, pch=20, cex=0.5,...) {
  ...
  label.default<-list(x="peak",y="peak",adj=NULL, pos=3, offset=0.5, 
                      col=NULL, fontface=NULL, fontsize=NULL, show=F,cex=1.3)
